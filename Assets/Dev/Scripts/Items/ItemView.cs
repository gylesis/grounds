...
namespace Dev.Scripts.Items
{
    public class ItemView : MonoBehaviour
    {
        ...
        private void UpdateView(float currentHealth, float maxHealth)
        {
            ...
            DOTween.Sequence()
                .Append(_meshRenderer.material.DOFloat(crackStrength * 2f, CrackStrengthName, 0.20f))
                .Join(_meshRenderer.material.DOFloat(3, EmissionStrengthName, 0.20f))
                .Append(_meshRenderer.material.DOFloat(crackStrength * 1f, CrackStrengthName, 0.80f))
                .Join(_meshRenderer.material.DOFloat(0, EmissionStrengthName, 0.20f));
